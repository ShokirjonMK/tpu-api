 ...
 */
class m230503_062424_create_student_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%student}}', [
            ...
            'edu_form_id' => $this->integer()->Null()->defaultValue(1)->comment('talim shakli'),
            ...
            'gender' => $this->tinyInteger(1)->Null()->comment('1-erkak 0-ayol'),

            'social_category_id' => $this->integer()->null()->comment('ijtimoiy toifa'),
