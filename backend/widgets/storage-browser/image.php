...
<div class="storage-browser-frame-group">
    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            ...
            <button type="button" class="btn btn-secondary" storage-browser-show="<?= $action ? $action : 'image'; ?>" storage-browser-select-type="<?= $select_type; ?>">
                <?= _e('Select'); ?>
            </button>
        </div>
    </div>
    ...
    <div class="storage-browser-data d-none">
        <input type="hidden" storage-browser-value="image" <?= $input_data ? implode(' ', $input_data) : ''; ?>>
