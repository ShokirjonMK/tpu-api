...
class SubjectsController extends BackendController
{
    ...
    public function actionPublished()
    {
        ...
        $where = ['subject.status' => 1, 'subject.deleted' => 0];
    ...
    public function actionUnpublished()
    {
        ...
        $where = ['subject.status' => 0, 'subject.deleted' => 0];
    ...
    public function page($type, $where_query, $bulk_actions, $where_in = array())
    {
        ...
        $query = Subject::getItems('', $args)->andWhere($where_query);
        ...
        if ($ajax == 'bulk-actions') {
            ...
            $output = Subject::ajaxAction($ajax_action, $ajax_item_id, $items);
        ...
        $page_types = Subject::getPageTypes($type);
    ...
    public function actionCreate()
    {
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $id = Subject::createItem($model, $info, $post_item);
    ...
    public function actionEdit()
    {
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $action = Subject::updateItem($model, $info, $post_item);
