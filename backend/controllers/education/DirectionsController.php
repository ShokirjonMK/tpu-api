 ...
 */
class DirectionsController extends BackendController
{
    public $url = '/education/directions';
    public $settings;
    ...
    public function actionPublished()
    {
        ...
        $where = ['direction.status' => 1, 'direction.deleted' => 0];
    ...
    public function actionUnpublished()
    {
        ...
        $where = ['direction.status' => 0, 'direction.deleted' => 0];
    ...
    public function page($type, $where_query, $bulk_actions, $where_in = array())
    {
        ...
        $query = Direction::getItems('', $args)->andWhere($where_query);
        ...
        if ($ajax == 'bulk-actions') {
            ...
            $output = Direction::ajaxAction($ajax_action, $ajax_item_id, $items);
        ...
        $page_types = Direction::getPageTypes($type);
    ...
    public function actionCreate()
    {
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $id = Direction::createItem($model, $info, $post_item);
    ...
    public function actionEdit()
    {
        ...
        $item = Direction::getItemToEdit($id);
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $action = Direction::updateItem($model, $info, $post_item);
