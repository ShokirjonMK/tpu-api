 ...
 */
class UniversitiesController extends BackendController
{
    public $url = '/directories/universities';
    public $settings;
    ...
    public function actionPublished()
    {
        ...
        $where = ['university.status' => 1, 'university.deleted' => 0];
    ...
    public function actionUnpublished()
    {
        ...
        $where = ['university.status' => 0, 'university.deleted' => 0];
    ...
    public function page($type, $where_query, $bulk_actions, $where_in = array())
    {
        ...
        $query = University::getItems('', $args)->andWhere($where_query);
        ...
        if ($ajax == 'bulk-actions') {
            ...
            $output = University::ajaxAction($ajax_action, $ajax_item_id, $items);
        ...
        $page_types = University::getPageTypes($type);
    ...
    public function actionCreate()
    {
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $id = University::createItem($model, $info, $post_item);
        ...
        $districts = Regions::listDistricts();
    ...
    public function actionEdit()
    {
        ...
        $item = University::getItemToEdit($id);
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $action = University::updateItem($model, $info, $post_item);
