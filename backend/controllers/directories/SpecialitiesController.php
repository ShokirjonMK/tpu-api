 ...
 */
class SpecialitiesController extends BackendController
{
    public $url = '/directories/specialities';
    public $settings;
    ...
    public function actionPublished()
    {
        ...
        $where = ['speciality.status' => 1, 'speciality.deleted' => 0];
    ...
    public function actionUnpublished()
    {
        ...
        $where = ['speciality.status' => 0, 'speciality.deleted' => 0];
    ...
    public function page($type, $where_query, $bulk_actions, $where_in = array())
    {
        ...
        $query = Speciality::getItems('', $args)->andWhere($where_query);
        ...
        if ($ajax == 'bulk-actions') {
            ...
            $output = Speciality::ajaxAction($ajax_action, $ajax_item_id, $items);
        ...
        $page_types = Speciality::getPageTypes($type);
    ...
    public function actionCreate()
    {
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $id = Speciality::createItem($model, $info, $post_item);
    ...
    public function actionEdit()
    {
        ...
        $item = Speciality::getItemToEdit($id);
        ...
        if ($post_item) {
            ...
            if ($model->load($post_item) && $info->load($post_item)) {
                $action = Speciality::updateItem($model, $info, $post_item);
