...
$this->title = array_value($segment_lexicon, 'title'); ?>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive table-with-actions">
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    <?php if ($segments) : ?>
                        <?php foreach ($segments as $key => $one) : ?>
                            <?php
                            ...
                            if ($one->info) {
                                ...
                                $info = SegmentInfos::find()
                                    ->where(['segment_id' => $one->id])
                                    ->one();
                            }
                            ...
                            <tr>
                                    ...
                                    <nav class="nav products-table-nav">
                                        <?php if ($items_with_parent) : ?>
                                            <li class="text-secondary align-items-center">
                                                <?= _e('Child items'); ?>: <?= count_segment_childs($one, 'child_count'); ?>
                                            </li>
                                        <?php endif; ?>
                                ...
                                <?php if ($langs) : ?>
                                    ...
                                    $translations = SegmentInfos::find()->where(['segment_id' => $one->id])->all();
                                ...
                                <td class="ta-icons-block">
                                    ...
                                    <?php endif; ?>
                                    <div class="ta-icons-in">
                                        <a href="<?= get_segment_url($info, 'admin_lexicon'); ?>" target="_blank">
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="<?= (5 + count($langs)); ?>" class="text-center table-not-found">
                                ...
                                <div class="h5">
                                    <?= array_value($segment_lexicon, 'not_found_message'); ?>
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?>
