...
<ul class="nav nav-tabs nav-tabs-custom nav-justified mb-3" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#student" role="tab">
            ...
            <span class="d-none d-sm-block"><?= _e('Study'); ?></span>
        </a>
    </li>
</ul>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 form-group">
                                <?= $form->field($profile, 'passport_pinip')->textInput(['class' => 'form-control','max-length' => true]) ?>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <?= $form->field($student, 'department_id')->dropDownList($chairs, [
                                    'class' => 'form-control select2',
                                    'prompt' => _e('...')
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <?= $form->field($student, 'education_direction_id')->dropDownList($directions, [
                                    'class' => 'form-control select2',
                                    'prompt' => _e('...')
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-2 form-group">
                                <?= $form->field($student, 'basis_of_learning')->dropDownList($basisOfLearning, [
                                    'class' => 'form-control select2',
                                    'prompt' => _e('...')
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-3 form-group">
                                <?= $form->field($student, 'diploma_number')->textInput(['class' => 'form-control']) ?>
                            </div>

                            <div class="col-md-3 form-group">
                                <?= $form->field($student, 'diploma_date')->textInput(['class' => 'form-control', 'type' => 'date']) ?>
                            </div>

                            <div class="col-md-3 form-group">
                                <?= $form->field($student, 'type_of_residence')->dropDownList($residenceTypes, [
                                    'class' => 'form-control select2',
                                    'prompt' => _e('...')
                                ]) ?>
                            </div>
                            <div class="col-md-3 form-group">
                                <?= $form->field($student, 'education_type')->dropDownList(EducationType::list(), [
                                    'class' => 'form-control select2',
                                    'prompt' => _e('...')
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                <?= $form->field($student, 'landlord_info')->textarea(['class' => 'form-control']) ?>
                            </div>

                            <div class="col-md-12 form-group">
                                <?= $form->field($student, 'student_live_with')->textarea(['class' => 'form-control']) ?>
                            </div>

                            <div class="col-md-12 form-group">
                                <?= $form->field($student, 'other_info')->textarea(['class' => 'form-control']) ?>
                            </div>
