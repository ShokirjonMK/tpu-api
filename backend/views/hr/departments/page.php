                    ...
                    <?php if ($content) : ?>
                        <?php foreach ($content as $key => $one) : ?>
                            ...
                            if ($one->info) {
                                ...
                                $info = DepartmentInfo::find()
                                    ->where(['department_id' => $one->id])
                                    ->one();
                            }
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <nav class="nav products-table-nav">
                                        ...
                                        <li class="text-secondary align-items-center">
                                            <?= _e('Child items'); ?>: <?= count($one->childs); ?>
                                        </li>
                                ...
                                <td>
                                    <?= ($one->parent_id) ? $one->parent->info->name : '-' ?>
                                </td>
