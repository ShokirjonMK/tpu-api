 ...
 */
class QrLetterOutgoing extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['letter_outgoing_id', 'letter_id', 'qr_code'], 'required'],
            [['qr_code','url'], 'safe'],
            [['letter_outgoing_id','letter_id','order', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
    ...
    {
        return $this->hasMany(LetterOutgoing::className(), ['id' => 'letter_outgoing_id']);
    }
